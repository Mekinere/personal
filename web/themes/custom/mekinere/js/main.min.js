jQuery(document).ready(function(l){}),jQuery(document).ready(function(l){}),jQuery(document).ready(function(l){$oldScroll=scrollY,$navbar=l("header"),l.scroll(function(){$oldScroll<scrollY&&($navbar.height=0)})}),jQuery(document).ready(function(l){$oldScroll=scrollY,$navbar=l("header"),l.scroll(function(){$oldScroll<scrollY&&($navbar.height=0)})}),jQuery(document).ready(function(l){$oldScroll=scrollY,$navbar=l("header"),l.scroll(function(){$oldScroll<scrollY&&($navbar.height=0)})});
