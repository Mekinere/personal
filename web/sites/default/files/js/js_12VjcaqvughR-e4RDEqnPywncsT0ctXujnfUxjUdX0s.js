...
jQuery(document).ready(function($){
    ...
    $hoverIcon.click(function() {
        var $project = $(this).closest(".field__item");
        var $others = $(".field--name-field-project").children(".field__item");
        // $others.not($project).addClass(".other");
        $(this).closest(".field__item").addClass(".expanded");

        // $others.not(".expanded").animate({
        //     width: "0%",
        // }, 500);
        ...
        // change div to absolute + resize on click, placed above other objects
    });
