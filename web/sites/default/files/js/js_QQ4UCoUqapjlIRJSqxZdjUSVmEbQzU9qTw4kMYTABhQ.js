...
jQuery(document).ready(function($){
    ...
    $.scroll(function() {
        ...
        if ($oldScroll < $scrollC) {
            $navbar.height() = 0;
        }
        else if ($oldScroll > $scrollC) {
            $navbar.height() = 100;
        }
        $oldScroll = $scrollC;
    });
    ...
    var $projectTitle = $(".field--name-title");
    
    $hoverIcon.hover(function() {
        $(this).closest(".field--name-field-hover").fadeTo(150, 1);
        $(this).closest(".field--name-field-project").find($projectTitle).fadeTo(200, 1);
    })
