...
jQuery(document).ready(function($){
    ...
    $hoverIcon.click(function() {
        var $project = $(this).closest(".node--type-project").find(".field--name-field-image");
        var $parent = $(this).closest(".field--name-field-project").children();
        $parent.children(".field--name-field-image").not($project).animate({
            width: "0%",
        }, 500);
