...
jQuery(document).ready(function($){
    ...
    var $why = $(".field--name-field-photo");

    $toggle.click(function() {
        var $color = $(".region-nav-main");

        if ($color.css("color") == "rgb(113, 16, 201)") {
            $color.animate({
                color: "#e1ba85"
            });
            $rare.animate({
                backgroundColor: "#c97110"
            });
            // $color.css("color", "#e1ba85");
            // $rare.css("background-color", "#c97110");
        } else {
            $color.animate({
                color: "#7110c9"
            });
            $rare.animate({
                backgroundColor: "#7110c9"
            });
            // $color.css("color", "#7110c9");
            // $rare.css("background-color", "#7110c9");
