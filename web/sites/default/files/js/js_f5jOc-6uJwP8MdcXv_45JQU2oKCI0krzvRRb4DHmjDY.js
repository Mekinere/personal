...
jQuery(document).ready(function($){
    ...
    // hopefully sticky navbar on the way up, disappear on the way down.
    // IT DOESNT WORK
    var $navbar = $(".navbar");
    ...
    // $(this).closest(".paragraph--type--galleries").find(".field--name-field-items") use this/closest to manipulate gallery traits
    // this should be used to make a gallery
    ...
    $hoverIcon.click(function() {
        ...
        $project.parent().animate({
            ...
            $(this).find(".field--name-field-desc").fadeTo(400, 1);
            $(this).find(".field--name-field-arrow").fadeTo(500, 1);
            $(this).find(".field--name-field-collapse").fadeTo(500, 1);
    ...
    $galleryWidth = $(".node--type-project").width();

    $collapse.click(function() { 
        var $project = $(this).closest(".node--type-project");
        var $others = $(".field--name-field-project").children().children(".node--type-project");

        $project.find(".field--name-field-desc").fadeTo(200, 0);
        $project.find(".field--name-field-arrow").fadeTo(200, 0);
        $project.find(".field--name-field-collapse").fadeTo(300, 0);
        ...
        $others.css("width", "initial");
        $others.css("height", "initial");
