...
jQuery(document).ready(function($){
    ...
    $button = $("#block-thetopbanner .field--name-field-paragraphs .field__item .paragraph--type--banner .field--name-field-button");

    $button.html('<a href="#block-contactblock">' + $button.html() + '</a>');
