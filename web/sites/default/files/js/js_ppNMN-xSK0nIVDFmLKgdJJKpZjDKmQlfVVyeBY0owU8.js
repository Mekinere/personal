...
jQuery(document).ready(function($){
    ...
    $(window).scroll(function() {
        ...
        if ($scrollC > $oldScroll) {
            ...
            $navbar.stop().animate({
                height: 0,
            }, 100, linear, $navbar.hide());
        }
        else {
            // $navbar.show();
            $navbar.stop().animate({
                height: 70,
            }, 100, linear, $navbar.show());
        }
    ...
    $hoverIcon.click(function() {
        var $project = $(this).closest(".node--type-project").find(".img-fluid");
        ...
        // div stays same size, image is set to absolute, placed above other objects
    });
