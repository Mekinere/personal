...
jQuery(document).ready(function($){
    ...
    $button = $("#block-thetopbanner .field--name-field-paragraphs .field__item .paragraph--type--banner .field--name-field-button p");

    $button.html($button.html() + '<a href="#block-contactblock"></a>');
