...
jQuery(document).ready(function($){
    ...
    $hoverIcon.click(function() {
        ...
        $projectImage = $(this).closest(".field--name-field-image");
    ...
    $collapse.click(function() { 
        ...
        $(this).find(".field--name-field-desc").fadeTo(200, 0);
        $(this).find(".field--name-field-arrow").fadeTo(200, 0);
        $(this).find(".field--name-field-collapse").fadeTo(300, 0);
